...
def plotSpectrumFromDict(spectrum, proportion, outFile):
    ...
    #Calculate scale factor to rescale spectrum by, if proportions is used this is the total mutations to
    #rescale to proportions, if not this is 1 so the mutations stay the same
    if proportion:
        tM = float(0) 
        for m in mutations:
            tM += float(spectrum[m])
    ...
    for mutation in mutations:
        mutationCounts.append(float(spectrum[mutation])/tM)
...
def plotRNADouble(spectrum, proportion, outFile):
    ...
    #Colours of the bars
    colours = ["red", "red", "red", "red", "red", "red", "red", "red", "red", "limegreen", "limegreen", "limegreen", "limegreen", "limegreen", "limegreen", "limegreen", "limegreen", "limegreen", "gold", "gold", "gold", "gold", "gold", "gold", "gold", "gold", "gold", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "dodgerblue", "orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange", "orange", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "mediumpurple", "cyan", "cyan", "cyan", "cyan", "cyan", "cyan", "cyan", "cyan", "cyan", "magenta", "magenta", "magenta", "magenta", "magenta", "magenta", "magenta", "magenta", "magenta", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "yellowgreen", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darksalmon", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "darkturquoise", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "goldenrod", "violet", "violet", "violet", "violet", "violet", "violet", "violet", "violet", "violet", "crimson", "crimson", "crimson", "crimson", "crimson", "crimson", "crimson", "crimson", "crimson", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "deepskyblue", "salmon", "salmon", "salmon", "salmon", "salmon", "salmon", "salmon", "salmon", "salmon"]
    colourSet = ["red", "limegreen", "gold", "dodgerblue", "orange", "mediumpurple", "cyan", "magenta", "yellowgreen", "darksalmon", "darkturquoise", "goldenrod", "violet", "crimson", "deepskyblue", "salmon"]
...
#Plots a comparison between 2 RNA SBS spectra
def plotRNASpectrumComparison(spectrum, outFile):
    #The 192 RNA mutations as a list, used so they are always in the same order
...
def plot_spectrum(args):
    ...
    if args.types and not args.rna:
        ...
        plotSpectrumFromDict(spectrum, args.plot_proportion, args.outFile)
