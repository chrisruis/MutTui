...
#Creates an empty double substitution mutational spcetrum dictionary for RNA datasets, i.e. not combining symmetric mutations
#Each entry is reference 1, reference 2, mutation 1, mutation 2
def getRNADoubleSubstitutionDict():
    mutation = OrderedDict()
    mutation["AACC"] = 0
    mutation["AACG"] = 0
    mutation["AACT"] = 0
